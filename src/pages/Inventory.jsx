...
import { Search, Plus, AlertCircle, X, Edit, Trash2, Box } from "lucide-react";
import {
  getAllMedicines,
  createMedicine,
  updateMedicine,
...
const Inventory = () => {
  ...
  const filteredMedicines = stockList.filter(
    (med) =>
  ...
  const handleSave = async (e) => {
    ...
    try {
      if (editingItem) {
        ...
        setStockList((current) => [...current, created]);
      }
      ...
      <div
        ...
        <div>
          ...
          <p
            ...
            Monitor batches and precise stock levels.
          </p>
        </div>
        ...
        <div className="modal-overlay" onClick={() => setSelectedMed(null)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <p
              ...
              Detailed information for {selectedMed.name}
            </p>
              ...
              <div
                ...
                <p
                  style={{
                    ...
                    fontSize: "1.1rem",
                    color:
                      new Date(selectedMed.expiry) < new Date()
                        ? "#EF4444"
                        : "inherit",
                  }}>
                  {selectedMed.expiry}
