  ...
  return (
    <div className="min-h-screen bg-white font-sans text-slate-800 antialiased">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center gap-8">
              <button onClick={() => scrollTo("features")} className="text-sm font-medium text-slate-600 hover:text-teal-600 transition">
                Features
              </button>
              <button onClick={() => scrollTo("how-it-works")} className="text-sm font-medium text-slate-600 hover:text-teal-600 transition">
                How It Works
              </button>
              <button onClick={() => scrollTo("pricing")} className="text-sm font-medium text-slate-600 hover:text-teal-600 transition">
                Pricing
              </button>
              <button onClick={() => scrollTo("faq")} className="text-sm font-medium text-slate-600 hover:text-teal-600 transition">
                FAQ
              </button>
            </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t border-slate-100 shadow-xl px-4 py-5 space-y-3">
            ...
            <button onClick={() => scrollTo("how-it-works")} className="block w-full text-left text-slate-700 font-medium py-2">How It Works</button>
            <button onClick={() => scrollTo("pricing")} className="block w-full text-left text-slate-700 font-medium py-2">Pricing</button>
            <button onClick={() => scrollTo("faq")} className="block w-full text-left text-slate-700 font-medium py-2">FAQ</button>
            <hr className="border-slate-100" />
            <button onClick={() => { setMobileMenuOpen(false); navigate("/login"); }} className="block w-full text-left text-slate-700 font-medium py-2">Log In</button>
            <button onClick={() => { setMobileMenuOpen(false); navigate("/signup"); }} className="w-full bg-teal-600 text-white py-3 rounded-xl font-semibold active:scale-95 transition">
              Start Free Trial
            </button>
          </div>
        )}
      ...
      <div className="pt-16 bg-gradient-to-r from-amber-500 via-orange-500 to-red-500 text-white py-2.5 text-center text-sm font-semibold tracking-wide">
        ⚠️ EFDA Traceability Mandate Deadline: June 3, 2026 — Get compliant in under 5 minutes
      </div>
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-slate-50 via-white to-white pt-16 pb-24 lg:pt-24 lg:pb-32">
        ...
        <div className="absolute bottom-10 right-10 w-96 h-96 bg-emerald-100 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse" style={{ animationDelay: "2s" }}></div>
        <div className="absolute top-40 right-1/4 w-48 h-48 bg-cyan-100 rounded-full mix-blend-multiply filter blur-3xl opacity-25 animate-pulse" style={{ animationDelay: "4s" }}></div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-slate-500 max-w-2xl mx-auto mb-10 leading-relaxed font-medium">
            The complete pharmacy operating system that eliminates expired stock, automates Telebirr payments, and keeps you EFDA-compliant — even when the internet goes down.
          </p>
          ...
          <div className="mt-16 pt-8 border-t border-slate-100">
            ...
            <div className="flex flex-wrap justify-center items-center gap-x-12 gap-y-4 text-slate-300 font-bold text-lg">
              <span className="hover:text-slate-500 transition cursor-default">Addis Ababa</span>
              <span className="text-slate-200">•</span>
              <span className="hover:text-slate-500 transition cursor-default">Hawassa</span>
              <span className="text-slate-200">•</span>
              <span className="hover:text-slate-500 transition cursor-default">Bahir Dar</span>
              <span className="text-slate-200">•</span>
              <span className="hover:text-slate-500 transition cursor-default">Adama</span>
              <span className="text-slate-200">•</span>
              <span className="hover:text-slate-500 transition cursor-default">Dire Dawa</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-white border-y border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              { value: "20%+", label: "Less Expired Stock", icon: TrendingUp, color: "text-emerald-600 bg-emerald-50" },
              { value: "99.9%", label: "System Uptime", icon: Zap, color: "text-amber-600 bg-amber-50" },
              { value: "< 5min", label: "Setup Time", icon: Clock, color: "text-blue-600 bg-blue-50" },
              { value: "2026", label: "EFDA Ready", icon: FileCheck, color: "text-teal-600 bg-teal-50" },
            ].map((stat, i) => (
              <div key={i} className="p-4 group">
                <div className={`w-12 h-12 ${stat.color} rounded-xl flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform`}>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <p className="text-sm font-bold text-teal-600 uppercase tracking-widest mb-3">The Problem We Solve</p>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 mb-4">
              Paper Ledgers Are Costing You Millions
            </h2>
            <p className="text-lg text-slate-500 max-w-2xl mx-auto">
              40% of Ethiopian pharmacies report significant financial losses from expired or missing stock. It's not your fault — it's your tools.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                <div className="mb-6">
                  <span className="text-4xl font-black text-slate-900">{item.stat}</span>
                  <p className="text-sm text-slate-400 font-medium mt-1">{item.statLabel}</p>
                </div>
      ...
      <section id="features" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <p className="text-sm font-bold text-teal-600 uppercase tracking-widest mb-3">Complete Pharmacy OS</p>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 mb-4">
              Everything You Need. Nothing You Don't.
            </h2>
            <p className="text-lg text-slate-500 max-w-2xl mx-auto">
              Six powerful modules working together to run your pharmacy like a precision machine.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              >
                <div className={`w-14 h-14 bg-gradient-to-br ${category.color} rounded-2xl flex items-center justify-center mb-5 shadow-lg group-hover:scale-110 transition-transform`}>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-slate-500 mb-8 leading-relaxed">
                Stop guessing what's on your shelves. PharmaCare tracks every medicine from arrival to sale with surgical precision.
              </p>
            ...
            <div className="space-y-4">
              {[
                { status: "In Stock", color: "bg-emerald-500", items: "Paracetamol 500mg — Batch #A2024-01", count: "1,240 units", expiry: "Exp: 2027-03" },
                { status: "Low Stock", color: "bg-amber-500", items: "Amoxicillin 250mg — Batch #B2024-15", count: "23 units", expiry: "Exp: 2026-08" },
                { status: "Expiring Soon", color: "bg-red-500", items: "Ibuprofen 400mg — Batch #C2023-42", count: "180 units", expiry: "Exp: 2026-07 ⚠️" },
                { status: "Out of Stock", color: "bg-slate-400", items: "Metformin 850mg — Batch #D2024-08", count: "0 units", expiry: "Reorder from KAL Pharma" },
              ].map((row, i) => (
                <div key={i} className="bg-white p-5 rounded-xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                      <span className={`w-2.5 h-2.5 ${row.color} rounded-full`}></span>
                      <span className="text-xs font-bold uppercase tracking-wide text-slate-500">{row.status}</span>
                    </div>
                    <span className="text-xs font-mono text-slate-400">{row.expiry}</span>
                  </div>
                  <p className="font-semibold text-slate-800 text-sm">{row.items}</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-2 lg:order-1">
              <div className="bg-slate-900 rounded-2xl p-6 shadow-2xl">
                <div className="bg-slate-800 rounded-xl p-4 mb-4">
                  <p className="text-xs text-slate-400 font-mono mb-3">RECEIPT — PHARMACARE POS</p>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {["Telebirr", "CBE Birr", "Cash", "Bank Transfer"].map((method, i) => (
                    <div key={i} className={`p-3 rounded-xl text-center text-sm font-semibold transition ${i === 0 ? "bg-teal-600 text-white" : "bg-slate-800 text-slate-400"}`}>
                      {method}
                    </div>
                  ))}
                </div>
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-lg text-slate-500 mb-8 leading-relaxed">
                Accept Telebirr, CBE Birr, cash, and bank transfers natively. No awkward workarounds. No foreign payment gateways.
              </p>
              <div className="space-y-5">
                {[
                  { icon: CreditCard, title: "Localized Payments", desc: "Telebirr, CBE Birr, Cash, and Bank Transfer built directly into the POS. Match how your customers actually pay." },
                  { icon: RotateCcw, title: "Smart Refunds", desc: "Process returns in one click. Stock is automatically restored to the correct batch. Inventory stays accurate." },
                  { icon: Printer, title: "Professional Receipts", desc: "Print clean, formatted receipts with VAT/TOT breakdowns, TIN numbers, and your pharmacy branding." },
                ].map((item, i) => (
                  <div key={i} className="flex gap-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-slate-500 mb-8 leading-relaxed">
                Most systems show you top-line sales. PharmaCare subtracts the exact batch cost to reveal what you actually earned.
              </p>
              <div className="space-y-5">
                {[
                  { icon: DollarSign, title: "Real Profit Calculation", desc: "Revenue minus specific batch cost. See the true margin on every medicine, not just vanity metrics." },
                  { icon: TrendingUp, title: "Top-Sellers & Payment Breakdown", desc: "Know which medicines drive profit and how customers prefer to pay. Make smarter purchasing decisions." },
                  { icon: FileText, title: "One-Click PDF Reports", desc: "Generate professional reports for tax season, accounting, and business planning in seconds." },
                  { icon: Calendar, title: "Flexible Timeframe Filtering", desc: "Analyze daily, weekly, monthly, or custom periods. Spot trends and compare performance over time." },
                ].map((item, i) => (
                  <div key={i} className="flex gap-4">
            ...
            <div className="space-y-4">
              <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
                <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-4">Monthly Profit Overview</p>
                <div className="flex items-end gap-2 h-32">
                  {[40, 55, 35, 70, 60, 85, 75, 90, 65, 80, 95, 88].map((h, i) => (
                    <div key={i} className="flex-1 bg-gradient-to-t from-teal-500 to-emerald-400 rounded-t-md transition-all hover:from-teal-600 hover:to-emerald-500" style={{ height: `${h}%` }}></div>
                  ))}
                </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm">
                  <p className="text-xs text-slate-400 font-medium mb-1">Real Profit</p>
                  <p className="text-2xl font-black text-emerald-600">+127,400</p>
                  <p className="text-xs text-slate-400">ETB this month</p>
                </div>
                <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm">
                  <p className="text-xs text-slate-400 font-medium mb-1">Expired Loss</p>
                  <p className="text-2xl font-black text-red-500">-3,200</p>
                  <p className="text-xs text-emerald-500 font-semibold">↓ 78% from last quarter</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-slate-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <p className="text-sm font-bold text-teal-400 uppercase tracking-widest mb-3">Built for Ethiopia</p>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black mb-4">
              Local Reality. Global Standards.
            </h2>
            <p className="text-lg text-slate-400 max-w-2xl mx-auto">
              We didn't adapt foreign software. We built from scratch for Ethiopian pharmacies, Ethiopian payments, and Ethiopian infrastructure.
            </p>
          </div>

          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: WifiOff, title: "Offline-First", desc: "Scan, sell, and manage stock during power outages. Auto-syncs when connectivity returns." },
              { icon: Languages, title: "አማርኛ & English", desc: "Instant language toggle per user role. Pharmacists use English, clerks use Amharic." },
              { icon: Calendar, title: "Ethiopian Calendar", desc: "Native E.C. dates, local time formatting, and fiscal year reporting built in." },
              { icon: CreditCard, title: "Telebirr Native", desc: "QR payments, subscription billing, and reconciliation in ETB. Zero forex risk." },
              { icon: FileCheck, title: "EFDA Compliant", desc: "Batch traceability, disposal workflows, and audit logs for Proclamation 1263/2021." },
              { icon: Lock, title: "Data Privacy", desc: "End-to-end encryption compliant with Proclamation 1321/2024. Your data stays yours." },
              { icon: Bell, title: "Push Notifications", desc: "Real-time browser alerts for low stock, expiring batches, and completed sales." },
              { icon: DollarSign, title: "Multi-Currency", desc: "Support for ETB, USD, and EUR for pharmacies dealing with international suppliers." },
            ].map((feat, i) => (
              <div key={i} className="group p-6 rounded-2xl bg-slate-800/50 border border-slate-700 hover:border-teal-500/50 hover:bg-slate-800 transition-all duration-300">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <p className="text-sm font-bold text-teal-600 uppercase tracking-widest mb-3">Team Management</p>
            <h2 className="text-3xl sm:text-4xl font-black text-slate-900 mb-4">
              Right Access. Right People. Zero Risk.
            </h2>
            <p className="text-lg text-slate-500 max-w-2xl mx-auto">
              Cashiers see the POS. Managers see reports. Owners see everything. Protect your data and prevent internal loss.
            </p>
          </div>
            ...
            {[
              {
                ...
                blocked: ["Financial Reports", "Inventory Settings", "Staff Management"],
                color: "border-blue-200 bg-blue-50/30",
              },
              {
                role: "Manager",
                access: ["POS Screen", "Inventory Management", "Financial Reports", "Supplier Orders"],
                blocked: ["System Settings", "Staff Onboarding"],
                color: "border-violet-200 bg-violet-50/30",
              },
              {
                role: "Admin / Owner",
                access: ["Full System Access", "Staff Management", "System Configuration", "All Reports & Audit Logs"],
                blocked: [],
                color: "border-teal-200 bg-teal-50/30",
              },
            ].map((tier, i) => (
              <div key={i} className={`p-6 rounded-2xl border-2 ${tier.color}`}>
                <h3 className="text-lg font-bold text-slate-900 mb-4">{tier.role}</h3>
      ...
      <section id="pricing" className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <p className="text-sm font-bold text-teal-600 uppercase tracking-widest mb-3">Simple Pricing</p>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 mb-4">
              Transparent ETB Pricing
            </h2>
            <p className="text-lg text-slate-500 max-w-2xl mx-auto">
              No USD pegging. No hidden fees. No surprises. Designed for pharmacy margins.
            </p>
          </div>
            ...
            {[
              {
                ...
                features: ["Up to 500 SKUs", "1 Branch", "3 Users", "Basic Expiry Alerts", "EFDA Compliance Reports", "Offline Mode"],
                popular: false,
              },
              {
                name: "Growth",
                ...
                features: ["Up to 2,000 SKUs", "2 Branches", "5 Users", "Telebirr Auto-Sync", "Demand Forecasting", "Priority Support", "PDF Report Export"],
                popular: true,
              },
              {
                name: "Business",
                ...
                features: ["Unlimited SKUs", "Unlimited Branches", "Unlimited Users", "API Access", "Custom Integrations", "Dedicated Account Manager", "Advanced Analytics"],
                popular: false,
              },
            ].map((tier, i) => (
              <div
              ...
              >
                ...
                <div className="flex items-baseline gap-1 mb-1">
                  ...
                  <span className="text-slate-400 font-medium">ETB{tier.period}</span>
                </div>
                <p className="text-xs text-teal-600 font-semibold mb-6">{tier.yearly} (save 17%)</p>
      ...
      <section id="faq" className="py-20 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <p className="text-sm font-bold text-teal-600 uppercase tracking-widest mb-3">FAQ</p>
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={i} className="bg-slate-50 border border-slate-100 rounded-xl overflow-hidden hover:border-slate-200 transition">
                <button
                  onClick={() => toggleFaq(i)}
      ...
      {/* FINAL CTA                                   */}
      {/* ═══════════════════════════════════════════ */}
      <section className="py-24 bg-gradient-to-br from-teal-600 via-teal-700 to-emerald-800 text-white relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-teal-100 mb-10 max-w-2xl mx-auto leading-relaxed">
            Join hundreds of Ethiopian pharmacies already eliminating waste, preventing stockouts, and staying ahead of EFDA regulations. Setup takes less than 5 minutes.
          </p>
      ...
      <footer className="bg-slate-900 text-slate-400 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-10 mb-12">
            <div>
              ...
              <p className="text-sm leading-relaxed mb-4">
                Ethiopia's first offline-ready pharmacy operating system. Built locally, for local realities.
              </p>
              <p className="text-xs text-slate-500">
                Compliant with EFDA Proclamation 1263/2021 & Data Protection Proclamation 1321/2024.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2.5 text-sm">
                ...
                <li><button onClick={() => scrollTo("pricing")} className="hover:text-teal-400 transition">Pricing</button></li>
                <li><button onClick={() => scrollTo("faq")} className="hover:text-teal-400 transition">FAQ</button></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2.5 text-sm">
                ...
                <li><a href="#" className="hover:text-teal-400 transition">Partners</a></li>
          ...
          <div className="pt-8 border-t border-slate-800 flex flex-col sm:flex-row justify-between items-center gap-4 text-sm">
            <p>&copy; {new Date().getFullYear()} PharmaCare Ethiopia. All rights reserved.</p>
            <p className="text-slate-500">Made with purpose in Addis Ababa 🇪🇹</p>
          </div>
        </div>
      </footer>
    </div>
