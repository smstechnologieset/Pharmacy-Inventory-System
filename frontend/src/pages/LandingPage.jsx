    ...
    return (
        <div className="min-h-screen bg-white font-sans text-slate-800 antialiased">
            ...
            <div className="pt-16 bg-gradient-to-r from-amber-500 via-orange-500 to-red-500 text-white py-2.5 text-center text-sm font-semibold tracking-wide">
                ⚠️ EFDA Traceability Mandate Deadline: June 3, 2026 — Get
                compliant in under 5 minutes
            </div>
            ...
            <section className="relative overflow-hidden bg-gradient-to-b from-slate-50 via-white to-white pt-16 pb-24 lg:pt-24 lg:pb-32">
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-lg sm:text-xl text-slate-500 max-w-2xl mx-auto mb-10 leading-relaxed font-medium">
                        The complete pharmacy operating system that eliminates
                        expired stock, automates Telebirr payments, and keeps
                        you EFDA-compliant — even when the internet goes down.
                    </p>
                    ...
                    <p className="text-sm text-slate-400 font-medium">
                        No credit card required &bull; Setup in 5 minutes &bull;
                        Cancel anytime
                    </p>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-lg text-slate-500 max-w-2xl mx-auto">
                            40% of Ethiopian pharmacies report significant
                            financial losses from expired or missing stock. It's
                            not your fault — it's your tools.
                        </p>
                    </div>
            ...
            <section id="features" className="py-20 bg-white">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-lg text-slate-500 max-w-2xl mx-auto">
                            Six powerful modules working together to run your
                            pharmacy like a precision machine.
                        </p>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <p className="text-lg text-slate-500 mb-8 leading-relaxed">
                                Stop guessing what's on your shelves. PharmaCare
                                tracks every medicine from arrival to sale with
                                surgical precision.
                            </p>
                                ...
                                >
                                    <div className="flex items-center justify-between mb-2">
                                        <div className="flex items-center gap-2">
                                            <span
                                                className={`w-2.5 h-2.5 ${row.color} rounded-full`}
                                            ></span>
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="order-1 lg:order-2">
                            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-50 text-blue-700 text-xs font-bold uppercase tracking-widest mb-6 border border-blue-100">
                                <CreditCard className="w-3.5 h-3.5" /> Point of
                                Sale
                            </div>
                            <h2 className="text-3xl sm:text-4xl font-black text-slate-900 mb-6 leading-tight">
                                Checkout That Works
                            ...
                            <p className="text-lg text-slate-500 mb-8 leading-relaxed">
                                Accept Telebirr, CBE Birr, cash, and bank
                                transfers natively. No awkward workarounds. No
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <p className="text-lg text-slate-500 mb-8 leading-relaxed">
                                Most systems show you top-line sales. PharmaCare
                                subtracts the exact batch cost to reveal what
                                you actually earned.
                            </p>
                            <div className="space-y-5">
                                {[
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-lg text-slate-400 max-w-2xl mx-auto">
                            We didn't adapt foreign software. We built from
                            scratch for Ethiopian pharmacies, Ethiopian
                            payments, and Ethiopian infrastructure.
                        </p>
                    </div>
            ...
            <section className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-lg text-slate-500 max-w-2xl mx-auto">
                            Cashiers see the POS. Managers see reports. Owners
                            see everything. Protect your data and prevent
                            internal loss.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                        {[
                            ...
                            <div
                                key={i}
                                className={`p-6 rounded-2xl border-2 ${tier.color}`}
                            >
                                <h3 className="text-lg font-bold text-slate-900 mb-4">
                                    {tier.role}
                                </h3>
            ...
            <section id="pricing" className="py-20 bg-slate-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-lg text-slate-500 max-w-2xl mx-auto">
                            No USD pegging. No hidden fees. No surprises.
                            Designed for pharmacy margins.
                        </p>
                    </div>
            ...
            <section className="py-24 bg-gradient-to-br from-teal-600 via-teal-700 to-emerald-800 text-white relative overflow-hidden">
                ...
                <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-lg text-teal-100 mb-10 max-w-2xl mx-auto leading-relaxed">
                        {" "}
                        Join hundreds of Ethiopian pharmacies already
                        eliminating waste, preventing stockouts, and staying
                        ahead of EFDA regulations. Setup takes less than 5
                        minutes.
                    </p>
                    ...
                    <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 text-sm text-teal-200">
                        ...
                        <span className="flex items-center gap-1.5">
                            <CheckCircle2 className="w-4 h-4" /> 14-day free
                            trial
                        </span>
                        <span className="flex items-center gap-1.5">
            ...
            <footer className="bg-slate-900 text-slate-400 py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid md:grid-cols-4 gap-10 mb-12">
                        <div>
                            ...
                            <p className="text-sm leading-relaxed mb-4">
                                Ethiopia's first offline-ready pharmacy
                                operating system. Built locally, for local
                                realities.
                            </p>
                            <p className="text-xs text-slate-500">
                                Compliant with EFDA Proclamation 1263/2021 &
                    ...
                    <div className="pt-8 border-t border-slate-800 flex flex-col sm:flex-row justify-between items-center gap-4 text-sm">
                        <p>
                            &copy; {new Date().getFullYear()} PharmaCare
